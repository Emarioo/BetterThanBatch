...
#include "basin/machine/x64_defs.h"

#include "basin/CompilerOptions.h"
#include "basin/Compiler.h"

#include "basin/extension/Reformatter.h"
...
bool X64Builder::generate() {
    ...
    for(int i=0;i<bytecode->externalRelocations.size();i++) {
        ...
        if(tinycode->index == rel.tinycode_index) {
            ...
            program->addNamedUndefinedRelocation(alias, off, rel.tinycode_index, lib_path, rel.type == BC_REL_GLOBAL_VAR || rel.type == BC_REL_GLOBAL_VAR_FUNCTION, rel.type == BC_REL_GLOBAL_VAR_FUNCTION);
            // found = true;
            // break;
        }
    }
