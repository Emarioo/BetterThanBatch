...
%LD% -g main.o startup.o -T link.ld -o main.elf
@REM %OBJDUMP% -d main.elf

@REM qemu-system-arm -semihosting -M xilinx-zynq-a9 -cpu cortex-a9 -nographic -serial mon:stdio -kernel main.elf
@REM  -s -S
