...
#define DECODE_REG_SIZE(X) (X==0?0:(1<<DECODE_REG_TYPE(X)));

// BC_REG_ALL can't be 0 because it's seen as no register so we do 8.
#define BC_REG_AL (ENCODE_REG_TYPE(BC_REG_8)|BC_AX)
#define BC_REG_BL (ENCODE_REG_TYPE(BC_REG_8)|BC_BX)
#define BC_REG_CL (ENCODE_REG_TYPE(BC_REG_8)|BC_CX)
#define BC_REG_DL (ENCODE_REG_TYPE(BC_REG_8)|BC_DX)
...
#define BC_REG_AX (ENCODE_REG_TYPE(BC_REG_16)|BC_AX)
#define BC_REG_BX (ENCODE_REG_TYPE(BC_REG_16)|BC_BX)
#define BC_REG_CX (ENCODE_REG_TYPE(BC_REG_16)|BC_CX)
#define BC_REG_DX (ENCODE_REG_TYPE(BC_REG_16)|BC_DX)

#define BC_REG_EAX (ENCODE_REG_TYPE(BC_REG_32)|BC_AX)
#define BC_REG_EBX (ENCODE_REG_TYPE(BC_REG_32)|BC_BX)
#define BC_REG_ECX (ENCODE_REG_TYPE(BC_REG_32)|BC_CX)
#define BC_REG_EDX (ENCODE_REG_TYPE(BC_REG_32)|BC_DX)

#define BC_REG_RAX (ENCODE_REG_TYPE(BC_REG_64)|BC_AX)
#define BC_REG_RBX (ENCODE_REG_TYPE(BC_REG_64)|BC_BX)
#define BC_REG_RCX (ENCODE_REG_TYPE(BC_REG_64)|BC_CX)
#define BC_REG_RDX (ENCODE_REG_TYPE(BC_REG_64)|BC_DX)
